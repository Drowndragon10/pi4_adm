...
import 'playerdetailspage_treinador.dart';

class JogadoresTreinadorPage extends StatefulWidget {
  const JogadoresTreinadorPage({super.key});

  @override
  State<JogadoresTreinadorPage> createState() => _JogadoresTreinadorPageState();
}

class _JogadoresTreinadorPageState extends State<JogadoresTreinadorPage> {
  ...
  void _viewDetails(dynamic atleta) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PlayerTreinadorDetailsPage(
          atleta: atleta,
